  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6" data-vacation-planner>
      <div className="flex items-center mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900">Plan Your Vacation</h2>
          <p className="text-sm text-gray-600">Submit vacation requests and track your time off</p>
        </div>
      </div>
