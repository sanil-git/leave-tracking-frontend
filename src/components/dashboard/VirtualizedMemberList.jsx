...
const MemberItem = React.memo(({ index, style, data }) => {
  ...
  return (
    <div style={style}>
      <div className="mx-4 my-2 bg-white rounded-lg border border-gray-200 hover:border-blue-200 hover:shadow-md transition-all duration-200">
              ...
              <div className="flex items-center space-x-4">
                <div className="text-center">
                  <div className="font-semibold text-gray-900">
                    {member.leaveBalance?.total || 0}
                  </div>
                  <div>Days left</div>
                </div>
                <div className="text-center">
                  <div className="font-semibold text-gray-900">
                    {member.leavesThisYear || 0}
                  </div>
                  <div>This year</div>
                </div>
              </div>
...
const MemberControls = React.memo(() => {
  const { state, setFilter, toggleModal } = useTeam();
...
const VirtualizedMemberList = React.memo(() => {
  const { members, allMembers, removeTeamMember, loading, teamStats } = useTeam();
