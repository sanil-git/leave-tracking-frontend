...
const ApprovalItem = React.memo(({ approval, onApprove, onReject, isProcessing }) => {
        ...
        <div className="flex items-start justify-between">
            ...
            <div className="flex-1 min-w-0">
              ...
              {approval.description && (
                <div className="mb-3">
                  ...
                  {isExpanded && (
                    <p className="mt-2 p-3 bg-gray-50 rounded-lg text-sm text-gray-700">
                      {approval.description}
                    </p>
                  )}
                </div>
          ...
          <div className="flex space-x-2 ml-4">
            <button
              ...
              className="bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg font-medium flex items-center space-x-2 transition-colors"
            >
              <CheckCircle size={16} />
              <span>Approve</span>
            </button>
...
// Main team approvals component
const TeamApprovals = React.memo(() => {
  const { approvals, loading, errors, approveLeave, rejectLeave } = useTeam();
            ...
            <div key={i} className="bg-white rounded-lg border border-gray-200 p-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <LoadingSkeleton className="h-4 w-64 mb-3" />
...
TeamApprovals.displayName = 'TeamApprovals';
